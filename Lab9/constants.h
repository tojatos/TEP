...
#define DEF_DIFF_EVOL_MAX_ITER 10000
#define DEF_DIFF_EVOL_POP_NUMBER 500
#define DEF_DIFF_EVOL_CROSS_PROB 0.7
#define DEF_DIFF_EVOL_DIFF_WEIGHT 0.4
#define DEF_DIFF_TOURNAMENT_SIZE 2
#define DEF_DIFF_EVOL_ITER_TIME 3.2

#define RAND_GREED_LAMBDA_START 0.0
#define RAND_GREED_LAMBDA_END 5.0
